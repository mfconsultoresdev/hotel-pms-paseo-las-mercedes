...
CREATE TABLE "fiscal_documents" (
    ...
    "currency" TEXT NOT NULL DEFAULT 'USD',
    "iva_amount" DECIMAL(12,2) NOT NULL DEFAULT 0,
    "municipal_tax" DECIMAL(12,2) NOT NULL DEFAULT 0,
    "legal_reference" TEXT,
    "authorized_by" TEXT,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "payment_plans_invoice_id_key" ON "payment_plans"("invoice_id");

-- CreateIndex
CREATE UNIQUE INDEX "fiscal_documents_document_number_key" ON "fiscal_documents"("document_number");

-- CreateIndex
CREATE UNIQUE INDEX "exchange_rates_hotel_id_from_currency_to_currency_effective_key" ON "exchange_rates"("hotel_id", "from_currency", "to_currency", "effective_date");
...
-- AddForeignKey
ALTER TABLE "collection_actions" ADD CONSTRAINT "collection_actions_hotel_id_fkey" FOREIGN KEY ("hotel_id") REFERENCES "hotels"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "collection_actions" ADD CONSTRAINT "collection_actions_invoice_id_fkey" FOREIGN KEY ("invoice_id") REFERENCES "invoices"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "payment_plans" ADD CONSTRAINT "payment_plans_hotel_id_fkey" FOREIGN KEY ("hotel_id") REFERENCES "hotels"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "payment_plan_installments" ADD CONSTRAINT "payment_plan_installments_payment_id_fkey" FOREIGN KEY ("payment_id") REFERENCES "payments"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "fiscal_documents" ADD CONSTRAINT "fiscal_documents_hotel_id_fkey" FOREIGN KEY ("hotel_id") REFERENCES "hotels"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "exchange_rates" ADD CONSTRAINT "exchange_rates_hotel_id_fkey" FOREIGN KEY ("hotel_id") REFERENCES "hotels"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
